 ...
 * @constructor
 */
function SeriesDetails({itemData, onClose}) {
    ...
    const favouritesService = new FavouritesService('series');
    ...
    const seriesCharactersQuery = async (seriesId) => {
    ...
    useEffect(() => {
        ...
        seriesCharactersQuery(itemData.id).then(
            data => {
